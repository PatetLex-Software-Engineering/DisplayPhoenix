package com.patetlex.displayphoenix.gamely.ui.impl;
...
public class GameGLFWPanel extends GamePanel {
    ...
    private static class GLFWCanvas extends Canvas {
        ...
        public void paint(Graphics g) {
            if (this.ds == null) {
                this.ds = JAWTFunctions.JAWT_GetDrawingSurface(this, this.awt.GetDrawingSurface());
                if (this.ds == null) {
            ...
            try {
                ...
                try {
                    ...
                    try (MemoryStack stack = MemoryStack.stackPush()) {
                        ...
                        GLFW.glfwGetFramebufferSize(this.context, pw, ph);
                        GL11.glViewport(0, 0, (int) (this.panel.getWidth() * 1.5F), (int) (this.panel.getHeight() * 1.5F));
