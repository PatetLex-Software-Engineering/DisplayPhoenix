...
public class LayerViewPanel extends JPanel implements LayerListener {
    ...
    public LayerViewPanel(CanvasPanel canvas) {
        ...
        CornerLayerButton addLayer = new CornerLayerButton(new ImageIcon(ImageHelper.overlay(ImageHelper.getImage(Application.getTheme().getWidgetStyle().getName() + "_plus").getImage(), Application.getTheme().getColorTheme().getAccentColor(), 1F)), new ImageIcon(ImageHelper.overlay(ImageHelper.getImage(Application.getTheme().getWidgetStyle().getName() + "_plus").getImage(), Color.GREEN, 1F)));
        ...
        CornerLayerButton removeLayer = new CornerLayerButton(new ImageIcon(ImageHelper.overlay(ImageHelper.rotate(ImageHelper.getImage(Application.getTheme().getWidgetStyle().getName() + "_plus").getImage(), 45F), Application.getTheme().getColorTheme().getAccentColor(), 1F)), new ImageIcon(ImageHelper.overlay(ImageHelper.rotate(ImageHelper.getImage(Application.getTheme().getWidgetStyle().getName() + "_plus").getImage(), 45F), Color.RED, 1F)));
