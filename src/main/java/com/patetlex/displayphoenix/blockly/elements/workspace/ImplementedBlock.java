package com.patetlex.displayphoenix.blockly.elements.workspace;
 ...
 * @author TBroski
 */
public class ImplementedBlock implements BlocklyXmlParser {
    ...
    public String toString() {
        return parseImplementedBlock(this);
    }
